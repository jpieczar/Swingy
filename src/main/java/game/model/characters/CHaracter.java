...
public class CHaracter {
	public static List<CHaracter> activeCharacters = new ArrayList<CHaracter>();
	public static int idCounter = 0;
	private int charID = 0;
	protected /*public*/ String name;
	private String[] availableClass = {"Mage", "Archer", "Knight", "Bandit", "Troll", "Dragon"};
	/*protected*/ public String characterClass;
	protected long lvl; // If this does not work, try a double.
	protected int exp;
	protected /*public*/ int atk;
	protected int def;
	protected int hp;
	private int xAxis;
	private int yAxis;
	...
	CHaracter(String name, int num, int opt, String[] fromFile) {
		if (opt == 0) {
			...
			if (num >= 3) {
				...
				setX(MapGenerator.mapCentre(MapGenerator.mapSize(Control.pubLvl)));
				setY(MapGenerator.mapCentre(MapGenerator.mapSize(Control.pubLvl)));
			}
		}
		else {
